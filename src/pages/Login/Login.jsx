...
const Login = () => {
    ...
    return (
        ...
        // </div>
        <div className="flex flex-col-reverse md:flex-row  items-center justify-center min-h-screen bg-gradient-to-r from-blue-50 to-blue-100">
            <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-4">
                <Lottie animationData={animationData} className="w-full max-w-md md:max-w-full" />
            </div>
            <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-4">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
                    <h2 className="text-2xl md:text-3xl font-extrabold text-center text-blue-600 mb-4 md:mb-6">Login to Your Account</h2>
                    <div className="space-y-4">
                        <input
                            {...register('email')}
                            type="email"
